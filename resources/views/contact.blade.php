...
<footer style="background-color: #1a202c; color: white; padding: 4rem 2rem 2rem;">
    <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 2rem; margin-bottom: 3rem;">
        ...
        <div> 
               <h4 style="font-family: 'Space Grotesk', sans-serif; font-size: 1.125rem; font-weight: 700; margin-bottom: 1.5rem; color: white;">Legal</h4>
            <ul style="list-style: none; padding: 0; margin: 0;">
                <li style="margin-bottom: 0.75rem;"><a href="{{ route('legal.notice') }}" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#4299e1'" onmouseout="this.style.color='#a0aec0'">Aviso Legal</a></li>
                <li style="margin-bottom: 0.75rem;"><a href="{{ route('legal.privacy') }}" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#4299e1'" onmouseout="this.style.color='#a0aec0'">Privacidad</a></li>
                <li style="margin-bottom: 0.75rem;"><a href="{{ route('legal.cookies') }}" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#4299e1'" onmouseout="this.style.color='#a0aec0'">Cookies</a></li>
                <li style="margin-bottom: 0.75rem;"><a href="{{ route('legal.terms') }}" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#4299e1'" onmouseout="this.style.color='#a0aec0'">Términos</a></li>
            </ul>
